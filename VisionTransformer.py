# -*- coding: utf-8 -*-
"""Standalone implementation of Vision Transformer."""
import PIL
import time
import torch
import torchvision
...
_DATA_PATH = '~/Dev/Vision/data/'  # Update data path variable.
_MODEL_PATH = '~/Dev/Vision/model/'  # Update model path variable.
...
train_dataset = torchvision.datasets.CIFAR10(_DATA_PATH, train=True,
                                        download=True, transform=transform)

test_dataset = torchvision.datasets.CIFAR10(_DATA_PATH, train=False,
                                       download=True, transform=transform)
